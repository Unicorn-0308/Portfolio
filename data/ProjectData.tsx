export const projectData = [
    {
        ...
        description:
            "A computer vision system that detects defects in textile fabrics using YOLOv5. The model identifies cuts, holes, thread errors, and stains in real-time, providing visual feedback for quality control.",
        image: "/fabric.webp",
    ...
    },
    {
        ...
        description:
            "A custom-built transformer model for text summarization, demonstrating the application of advanced NLP techniques for content compression while maintaining context and meaning.",
        image: "/custom.webp",
    ...
    },
    {
        ...
        description:
            "An intelligent system that helps users customize their vehicles using voice or text input. Powered by Generative AI, Whisper AI, and DALL-E for personalized suggestions and visual previews.",
